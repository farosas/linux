					   ...
					   u64 hv_ptr, u64 regs_ptr)
{
	...
	r = kvm_vcpu_read_guest(vcpu, hv_ptr, l2_hv, size) ||
					    ...
					    u64 hv_ptr, u64 regs_ptr)
{
	...
	r = kvm_vcpu_write_guest(vcpu, hv_ptr, l2_hv, size) ||
...
long kvmhv_enter_nested_guest(struct kvm_vcpu *vcpu, u64 hv_ptr, u64 regs_ptr)
{
	long int err, r;
